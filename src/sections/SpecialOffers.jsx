  ...
  return (
    <section className='flex justify-wrap items-center max-xl:flex-col-reverse gap-10'>
        ...
        <p className='mt-6 lg:max-w-lg info-text'>
          Navigate a realm of possibilities designed to fullfill you unique desires, surpassing the loftiest experctations. Your journey with us is nothing short of exveptional.
        </ p>
